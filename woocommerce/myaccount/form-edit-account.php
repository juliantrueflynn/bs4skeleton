...
<form class="woocommerce-EditAccountForm edit-account" action="" method="post">
	...
	<div class="row">
		<div class="woocommerce-form-row woocommerce-form-row--first form-row form-row-first col-sm">
			<label for="account_first_name"><?php esc_attr_e( 'First name', 'bs4' ); ?> <span class="required text-danger">*</span></label>
		...
		<div class="woocommerce-form-row woocommerce-form-row--last form-row form-row-last col-sm">
			<label for="account_last_name"><?php esc_attr_e( 'Last name', 'bs4' ); ?> <span class="required text-danger">*</span></label>
	...
	<div class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide form-group">
		<label for="account_email"><?php esc_attr_e( 'Email address', 'bs4' ); ?> <span class="required text-danger">*</span></label>
	...
	<fieldset>
		<legend><?php esc_attr_e( 'Password change', 'bs4' ); ?></legend>

		<div class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide form-group">
			<label for="password_current"><?php esc_attr_e( 'Current password (leave blank to leave unchanged)', 'bs4' ); ?></label>
		...
		<div class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide form-group">
			<label for="password_1"><?php esc_attr_e( 'New password (leave blank to leave unchanged)', 'bs4' ); ?></label>
		...
		<div class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide form-group">
			<label for="password_2"><?php esc_attr_e( 'Confirm new password', 'bs4' ); ?></label>
	...
	<input type="submit" <?php bs4_btn_class( 'woocommerce-Button button' ); ?> value="<?php esc_attr_e( 'Save changes', 'bs4' ); ?>" />
