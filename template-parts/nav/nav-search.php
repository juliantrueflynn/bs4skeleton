<?php
/**
 * Template for navigation search forms
 *
...
<form role="search" method="get" class="search-form nav-search form-inline" action="<?php echo esc_url( home_url( '/' ) ); ?>">
	...
	<div class="input-group">
		<span class="input-group-btn">
			<button type="submit" <?php bs4_btn_class( 'btn-secondary btn-search' ); ?>>
